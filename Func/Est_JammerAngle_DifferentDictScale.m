function [varphi_J, theta_J] = Est_JammerAngle_DifferentDictScale(Para, Y_J2U, DictScale)
...
varphi_J = floor((I-1)/Para.N_a_azi)*DictScale-90;
theta_J = mod(I-1, Para.N_a_azi)*DictScale-90;
