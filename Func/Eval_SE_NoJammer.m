function [SE_up, SE_dn] = Eval_SE_NoJammer(Para, Best_RadiationPattern, Sele_RadiationPattern, Best_Cmber, Sele_Cmber)
%%
% input
%       Para
...
%% 1. Best
    ...
    sigma2_Best_up = Para.sigma_U_tx^2;
...
%% 2. reconfigurable antenna
    ...
    sigma2_RPA_up = Para.sigma_U_tx^2;
...
%% 3. Omini-directional 
    ...
    sigma2_omini_up = Para.sigma_U_tx^2;
    sigma2_omini_dn = Para.sigma_C_tx^2;
    power_allocation_omini_up = Water_Filling(Sele_Cmber'*Para.H_C, 10^(Para.P_C/10), sigma2_omini_up);
    ...
    SE_up(3) = log2(1 + S_Omini_up(1)*power_allocation_omini_up*S_Omini_up(1)/sigma2_omini_up);
