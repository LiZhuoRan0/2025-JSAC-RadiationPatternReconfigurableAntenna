function [varphi_C, theta_C, gain_norm, gain] = Est_CtrlerAngle_DifferentDictScale(Para, Y_C2U, DictScale)
%% Initial sensing of controler's angle
% input
%       Para
%       Y_C2U           received signal from controler to UAV, 
%                       Para.N_ant_U × Para.N_s × Para.N_h
%       DictScale       0.5, 1, 2, represent angle spacing
% output
...
varphi = repelem(-90:DictScale:90, 180/DictScale+1);
theta = repmat(-90:DictScale:90, 1, 180/DictScale+1);
...
varphi_C = floor((index.'-1)./Para.N_a_azi)*DictScale-90;
theta_C = mod(index.'-1, Para.N_a_azi)*DictScale-90;
