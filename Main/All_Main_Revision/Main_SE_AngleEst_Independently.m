...
P_C_all  =  [27 29 31 33   27 29 31 33   27 29 31 33];
HPBW_all =  [45 45 45 45   65 65 65 65   65 65 65 65];
N_all    =  [11 11 11 11   11 11 11 11    9  9  9  9];
P_J      =  50;
...
SavePath = sprintf('../Data/Simu/SE_Independent_%s_%s_%s_N_%d_Antenna_%d.mat', ...
...
for n_sit = 1:LenSituation
    ...
    parfor n_it = 1:N_it
        ...
        %% 2. Sensing of Jammer
            Y_C2U = Gen_RcvSig(Para, 'Jammer2UAV');
